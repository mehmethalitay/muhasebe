...
namespace Muhasebe
{
    public partial class satis_yap : Form
    {
        ...
        private void yenile()
        {
            try
            {
                da = new SQLiteDataAdapter("Select * From SatisYap", cnstr1.baglan());
                ds = new DataSet();
                da.Fill(ds, "SatisYap");
                dataGridView2.DataSource = ds.Tables["SatisYap"];
        ...
        private void satis_yap_Load(object sender, EventArgs e)
        {
            ...
            SQLiteCommand komut = new SQLiteCommand("select * from SatisYap", cnstr1.baglan());
            SQLiteCommand komut1 = new SQLiteCommand("select * from SatisYap", cnstr1.baglan());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SQLiteCommand komut = new SQLiteCommand("insert into SatisYap ( UrunAdi, UrunGrubu, UrunBirim, UrunSayi, Fiyat, UrunKdv, UrunIsk, UrunSatisF, Barkod, Stok)" +
        ...
        {
            SQLiteCommand komut = new SQLiteCommand("delete from SatisYap where id=@id", cnstr1.baglan());
        ...
        private void satis_yap_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                DialogResult sonuc = new DialogResult();
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
...

            {
                ...
                SQLiteCommand komut = new SQLiteCommand("update SatisYap set Tarih = @tarih " , cnstr1.baglan());
        ...
        private void dataGridView2_CellValueChanged_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            topfiyat();
            alankalan();
            //label33.Text = dataGridView2.CurrentRow.Cells[13].Value.ToString();
        }
        ...
        {
            MessageBox.Show(richTextBox18.Text + " " + "Adlı kişiye satış yapmak istiyormusunuz ?");
            ...
            try
            {
                ...
                for (int i = 0; i < dataGridView2.Rows.Count; ++i)
                {
                    ...
                    SQLiteCommand komut = new SQLiteCommand("insert into Faturalar ( musteriId, AdSoyadekle, UrunKodu, UrunGrubu, UrunBirim, UrunSayi, Fiyat, UrunKdv, UrunIsk, UrunSatisF, Tarih, Topfiyat, Alinan, Bakiye )" +
                      "values ( @musteriId, @adsoyadekle, @urunkodu, @urungrubu, @urunbirim, @urunsayi, @fiyat, @urunKdv, @urunisk, @urunsatisf, @tarih, @topfiyat, @alinan, @bakiye)", cnstr1.baglan());
                ...
                SQLiteCommand komut1 = new SQLiteCommand("delete from SatisYap", cnstr1.baglan());
